...
public class TesteMontagem2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ControleMotores.InicializaMotores(new FileInputStream("TestesTxt/TesteTraducaoMontagem2.txt"));
        } catch (IOException e) {
        ...
        ControleGerador.ParaMaquina();

        for (LinhaAssembly l:ControleGerador.codigoAssembly) {
            Geral.PrintLinhaMaquina(l);
        }
    }
}
